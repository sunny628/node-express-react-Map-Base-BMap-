	...
	render: function() {
		return ( 
			React.createElement("div", {className: "container app"}, 
				React.createElement("h1", {className: "text-center text-info"}, " React_GoogleMap "), 
				React.createElement(Search, {onSearch: this.searchForAddress}), 
				React.createElement(Map, {latlng: this.state.mapCoordinates, 
...
var CurrentLocation=React.createClass({displayName: "CurrentLocation",
	...
	render:function(){
		...
		return (
				React.createElement("div", {className: "map-current-site alert alert-success"}, 
					React.createElement("h4", {className: "text-center"}, 
						this.props.address, " ", React.createElement("i", {className: starClassName, onClick: this.toggleFavorite})
					)
				)
			)
	}
...
var LocationItem=React.createClass({displayName: "LocationItem",
	...
	render:function(){
		...
		return (
				React.createElement("a", {className: itemClassName, onClick: this.handleClick, style: style}, 
					this.props.address, 
					React.createElement("i", {className: "glyphicon glyphicon-menu-right pull-right"})
				)
			)
	}
});
...
var Item=React.createClass({displayName: "Item",
	render:function(){
		...
		return (
			React.createElement("a", {className: itemClassName}, "您还未收藏任何地址，请点击星号进行收藏.")
			)
	}
})
...
var LocationList=React.createClass({displayName: "LocationList",
	render:function(){
		...
		var locations=this.props.locations.map(function(location,index){
			...
			return React.createElement(LocationItem, {address: location, 
			timestamp: location.timestamp, 
			active: active, 
			onClick: self.props.onClick})
		});
		if(!locations.length){
			locations.push(React.createElement(Item, null))
		};
		return (
			React.createElement("div", {className: "map-lacation-list"}, 
				React.createElement("div", {className: "list-group"}, 
				React.createElement("span", {className: "list-group-item active"}, "收藏的地址"), 
				locations
				)
			)
			)
...
var Map = React.createClass({displayName: "Map",
	...
	*/
	...
	render: function() {
		return ( React.createElement("div", {className: "map-google-container", 
			id: "maps"}, 
				...
				React.createElement("div", {className: "form-horizontal map-search-form"}, 
						React.createElement("div", {className: "input-group"}, 
							...
							React.createElement("select", {ref: "areaRange", style: selectStyle, onChange: this.handleSubmit}, 
								React.createElement("option", {value: "中国"}, "中国"), 
								React.createElement("option", {value: "福建省"}, "福建省"), 
								React.createElement("option", {value: "福建省福州"}, "福州"), 
								React.createElement("option", {value: "福建省福州福州", selected: true}, "闽侯县")
							)
							), 
							React.createElement("input", {ref: "searchFor", value: this.state.value, onChange: this.handleChange, type: "text", className: "form-control", name: "mapSite", placeholder: "请输入要查询的地点....."}), 
...
React.render(
	React.createElement(GMapApp, null),
	document.getElementById('app')
)

},{"./components/BMapApp":1,"react":163}],8:[function(require,module,exports){
